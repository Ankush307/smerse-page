...
const Hero = () => {
    return (
        <div id='home' className='bg-cover lg:pt-[100px] sm:pt-[179px] pt-[163px] bg-no-repeat bg-center bg-hero-bg-img max-xl:bg-hero-bg-img-xl max-md:bg-hero-bg-img-md relative overflow-hidden'>
            <Header />
