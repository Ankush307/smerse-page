...
const Hero = () => {
    return (
        <div className='bg-cover pt-[100px] bg-no-repeat bg-center bg-hero-bg-img max-xl:bg-hero-bg-img-xl max-md:bg-hero-bg-img-md relative overflow-hidden'>
            <Header />
            ...
            <div className="container mx-auto flex flex-col items-center justify-center relative z-[1]">
                ...
                <div className="relative max-md:pt-10">
                    <h1 className="pt-8 text-8xl font-black text-white tracking-[6px] relative z-10 leading-custom-md max-md:text-[40px] ">SMERSE</h1>
                ...
                <h2 className='lg:text-4xl md:text-3xl text-2xl font-semibold sm:leading-[54px] text-white max-w-[637px] text-center tracking-[6%] pt-2.5 pb-11'>FOR A WHEALTHIER LIFESTYLE. ANYTIME, ANYWHERE</h2>
