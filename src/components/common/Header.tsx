...
const Header = () => {
  ...
  return (
    <div
      className={`px-4 !mx-auto py-5 w-full fixed top-0 z-10 transition-all duration-300 ${
      ...
      <div className="container mx-auto flex items-center justify-between max-w-[1140px] ">
        <a href="/">
          <img
            ...
            alt="page-logo"
            className="pointer-events-none size-[68px]"
          />
        </a>
        <div
        ...
        <div className="flex items-center justify-center gap-10 lg:hidden">
          ...
          <button
            onClick={handleClick}
            className="flex flex-col items-center justify-between relative z-20 overflow-hidden sm:h-8 sm:w-[39px] h-[19px] w-5 lg:hidden"
          >
            <span
              className={`w-full h-[3px] sm:h-[5px] transition-all duration-300 bg-white rounded-lg ${
                open ? " translate-x-10" : ""
              }`}
            ></span>
            <span
            ...
            ></span>
            <span
              className={`w-full h-[3px] sm:h-[5px] transition-all duration-300 bg-white rounded-lg relative after:absolute after:top-0 after:left-0 after:w-full sm:after:h-[5px] after:h-[3px] after:bg-white after:rounded-lg ${
                open
                  ? "after:rotate-90 rotate-45 -translate-y-2 sm:-translate-y-3 "
                  : "after:hidden"
              }`}
            ></span>
          </button>
